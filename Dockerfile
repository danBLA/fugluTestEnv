...
RUN pip2 install rarfile mock dkimpy dnspython pydns pyspf==2.0.12t ipaddr rednose ssdeep==3.2 redis geoip2 beautifulsoup4 lxml
RUN pip3 install --upgrade pip 'setuptools>=20.2.2'
RUN pip3 install rarfile rednose  sqlalchemy python-magic pyspf py3dns mock ssdeep redis geoip2 beautifulsoup4 lxml
