...
RUN pip3 install rarfile rednose  sqlalchemy python-magic pyspf py3dns mock ssdeep redis
RUN wget https://github.com/fumail/domainmagic/archive/master.zip; unzip -e master; cd domainmagic-master/; python setup.py install --force; python3 setup.py install --force; cd -; rm -rf domainmagic-master master.zip
